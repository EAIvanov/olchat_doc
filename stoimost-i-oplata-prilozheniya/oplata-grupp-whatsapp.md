...
{% hint style="info" %}
Если оплачены 10 групп, но вы планируете перейти на большее количество групп, то остаток будет автоматически пересчитан по количеству дней.
{% endhint %}

{% hint style="warning" %}
Если у вас закончился тариф платных групп, и вы планируете вернуть одну бесплатную группу, то нужно написать нам в поддержку.
{% endhint %}
