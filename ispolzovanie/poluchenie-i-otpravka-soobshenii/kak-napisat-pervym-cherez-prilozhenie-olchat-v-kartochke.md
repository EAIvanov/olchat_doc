...
{% hint style="info" %}
При написании сообщений из приложения в карточке CRM, создающийся чат распределяется не в общую очередь Открытой линии или на ответственного сотрудника, а сразу на его создателя.
{% endhint %}
