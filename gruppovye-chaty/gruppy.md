...
{% hint style="info" %}
При добавлении пользователя в группу вы можете столкнуться с ошибкой добавления. Точная причина такой ситуации неизвестна, т.к. WhatsApp не делится данной информацией. Возможные причины:
